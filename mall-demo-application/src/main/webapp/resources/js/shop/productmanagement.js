$(function() {
    // 获取此店铺下的商品列表的URL
    var listUrl = '/mall-demo/shopadmin/getproductlistbyshop?pageIndex=1&pageSize=999';
    // 商品下架URL
    var statusUrl = '/mall-demo/shopadmin/modifyproduct';
    getList();
    /**
     * 获取此店铺下的商品列表
     *
        ...
        .on(
            ...
            function(e) {
                ...
                if (target.hasClass('edit')) {
                    ...
                    window.location.href = '/mall-demo/shopadmin/productoperation?productId='
                    ...
                    window.location.href = '/mall-demo/frontend/productdetail?productId='
                        + e.currentTarget.dataset.id;
                }
            });
