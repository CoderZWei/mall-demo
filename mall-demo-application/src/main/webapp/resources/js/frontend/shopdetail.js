$(function() {
    ...
    var pageSize = 3;
    // 列出商品列表的URL
    var listUrl = '/mall-demo/frontend/listproductsbyshop';
    // 默认的页码
    var pageNum = 1;
    // 从地址栏里获取ShopId
    ...
    var searchDivUrl = '/mall-demo/frontend/listshopdetailpageinfo?shopId=' + shopId;
    ...
    // $('#exchangelist').attr('href', '/mall-demo/frontend/awardlist?shopId=' +
    // shopId);
    // 获取本店铺信息以及商品类别信息列表
