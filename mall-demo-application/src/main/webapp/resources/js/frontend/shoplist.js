$(function() {
    ...
    var pageSize = 3;
    // 获取店铺列表的URL
    var listUrl = '/mall-demo/frontend/listshops';
    // 获取店铺类别列表以及区域列表的URL
    var searchDivUrl = '/mall-demo/frontend/listshopspageinfo';
    // 页码
    var pageNum = 1;
    ...
    $('.shop-list').on('click', '.card', function(e) {
        ...
        window.location.href = '/mall-demo/frontend/shopdetail?shopId=' + shopId;
    });
