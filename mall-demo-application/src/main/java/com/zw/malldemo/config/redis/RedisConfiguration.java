package com.zw.malldemo.config.redis;

import com.zw.malldemo.cache.JedisPoolWriter;
...
public class RedisConfiguration {
    ...
    public JedisPoolWriter createJedisPoolWriter(){
        JedisPoolWriter jedisPoolWriter=new JedisPoolWriter(jedisPoolConfig,hostname,port);
